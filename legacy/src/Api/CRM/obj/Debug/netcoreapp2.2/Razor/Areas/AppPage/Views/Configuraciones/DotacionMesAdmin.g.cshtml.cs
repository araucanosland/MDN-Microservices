#pragma checksum "C:\Users\17042783-1.LAARAUCANA\Source\Mdn-Dev\MDN-Microservices\legacy\src\Api\CRM\Areas\AppPage\Views\Configuraciones\DotacionMesAdmin.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7a406ef24c20696633aa46f691086b5c885fa190"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Areas_AppPage_Views_Configuraciones_DotacionMesAdmin), @"mvc.1.0.view", @"/Areas/AppPage/Views/Configuraciones/DotacionMesAdmin.cshtml")]
[assembly:global::Microsoft.AspNetCore.Mvc.Razor.Compilation.RazorViewAttribute(@"/Areas/AppPage/Views/Configuraciones/DotacionMesAdmin.cshtml", typeof(AspNetCore.Areas_AppPage_Views_Configuraciones_DotacionMesAdmin))]
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7a406ef24c20696633aa46f691086b5c885fa190", @"/Areas/AppPage/Views/Configuraciones/DotacionMesAdmin.cshtml")]
    public class Areas_AppPage_Views_Configuraciones_DotacionMesAdmin : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        ...
        {
#line 1 "C:\Users\17042783-1.LAARAUCANA\Source\Mdn-Dev\MDN-Microservices\legacy\src\Api\CRM\Areas\AppPage\Views\Configuraciones\DotacionMesAdmin.cshtml"
  
    Layout = "~/Views/Shared/_MdnLayout.cshtml";

#line default
#line hidden
            BeginContext(57, 94, false);
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("link", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagOnly, "7a406ef24c20696633aa46f691086b5c885fa1904307", async() => {
            }
            );
        ...
        <div class=""col-lg-12"">
            ...
            <div class=""tab-base"">
                ...
                <ul class=""nav nav-tabs"">
                    <li class=""active"">
                        <a data-toggle=""tab"" href=""#demo-lft-tab-1"" aria-expanded=""true"" id=""tab_preaprobados"">Administrador Dotación</a>
                    </li>
                ...
                <form id=""form-registro-ausencia"">
                    ...
                    <div class=""modal-body"">
                        ...
                        <div class=""form-group"">
                            <label>Motivo</label>
                            <select cla");
            WriteLiteral(@"ss=""form-control desabilitable"" id=""slMotivo"" name=""motivo""></select>
                        </div>
                        <div class=""form-group"">
                        ...
                        <div class=""form-group"" id=""dvCantidadDias"">
                            ...
                            <input type=""text"" id=""tb-c");
            WriteLiteral(@"antidad-dias"" name=""dias"" class=""form-control desabilitable"" />
                        </div>
...
");
            ...
            DefineSection("script", async() => {
                BeginContext(14881, 8, true);
                WriteLiteral("\r\n\r\n    ");
                EndContext();
                BeginContext(14889, 86, false);
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "7a406ef24c20696633aa46f691086b5c885fa19021332", async() => {
                }
                );
                __Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.Razor.TagHelpers.UrlResolutionTagHelper>();
                __tagHelperExecutionContext.Add(__Microsoft_AspNetCore_Mvc_Razor_TagHelpers_UrlResolutionTagHelper);
        ...
        $(function () {
            ...
            var cargador = {
                CargaMes: function (fecha_vista) {
                    ...
                    $(""#thCountDias"").prop({ ""colspan"": diasMes.length }).html('<button class=""btn btn-primary"" style=""float:left;"" id=""btn_atras""><</button>' + leyendaMeses[fecha_vista.getMonth()] + "" "" + fecha_vista.getFullYear() + '<button style=""float:right;"" class=""btn ");
                WriteLiteral(@"btn-primary"" id=""btn_adelante"">></button>').css({ ""text-align"": ""center"" })

                    $.SecGetJSON(BASE_URL + ""/motor/api/Config/dotacion-data-admin"", { periodo: tperiodo, codOficina: httpGet(""CodOficina"") }, function (obj) {
                        ...
                        $(""#p_capacity"").html(ResumenesAusencia['acti");
                WriteLiteral(@"vos'].Porcentaje + ""%"")
                        ...
                        $(""#n_desvinculaciones"").html(Resumenes");
                WriteLiteral(@"Ausencia['desvinculacion'].Numero)
                        ...
                        $.each(diasMes, function (i, e) {
                            ...
                            if (e.toString().charAt(0) === ""S"" || $.inArray(d, FeriadosMes) > -1) {
                                ...
                                $(""#trDiasMes"").append($(""<th>"").html((i + 1).toString().paddingLeft(""");
                WriteLiteral(@"00"")).addClass(""chly-dia-inhabil"").css({ ""text-align"": ""center"" }).addClass(""charly-letra-chik""))
                            } else {
                                ...
                                if (d === (dh.getFullYear().toString() + (dh.getMonth() + 1).toString().paddingLeft(""00"") + dh.getDate())) {
                                    ...
                                    $(""#trDiasMes"").append($(""<th>"").html((i + 1).toString().paddingLeft(""00"")).css({ ""text-align"": ""center"" }).addCl");
                WriteLiteral(@"ass(""charly-letra-chik""))
                                }
                        ...
                        $.each(obj.Ejecutivos, function (inej, ejecutivo) {
                            ...
                            $.each(ejecutivo.PeriodoAusencia, function (i, e) {
                                daus = daus.concat(getDaysNoTrabajados(e.aus_fech");
                WriteLiteral(@"a_inicio, e.aus_fecha_fin, e));
                            })
                            ...
                            var dAusencias = $(daus).map(function () {
                               ...
                               ");
                WriteLiteral(@"     EsRangoFechas: foj.taus_es_rango_fechas,
                            ...
                            $.each(diasMes, function (i, dia) {
                                ...
                                if (dia.toString().charAt(0) === ""S"" || $.inArray(d, FeriadosMes) > -1) {
                                    ...
                                    if ($.inArray(d, dAusencias) > -1 && arrayObjetoAusencia[d].EsDiasCorridos) {
                                        $(""#"" + ejecutivo.Ejecutivo.Rut).append($('<td title=""' + arrayObjetoAusencia[d].Leyenda + '"">').addClass(arrayObjetoAusencia[d].Color).addClass(""ausencia-general"").da");
                WriteLiteral(@"ta({ ""ausencia"": arrayObjetoAusencia[d].Ausencia }).on(""dblclick"", cargador.EdicionAusencia))
                                    } else {
                                    ...
                                    if ($.inArray(d, dAusencias) > -1 && !arrayObjetoAusencia[d].EsRangoFechas) {
                                        ...
                                        $(""#"" + ejecutivo.Ejecutivo.Rut).append($('<td title=""' + ar");
                WriteLiteral(@"rayObjetoAusencia[d].Leyenda + '"">').addClass(arrayObjetoAusencia[d].Color).addClass(""ausencia-general"").data({ ""ausencia"": arrayObjetoAusencia[d].Ausencia }).on(""dblclick"", cargador.EdicionAusencia))
                  ...
                  ");
                WriteLiteral(@"      $.each(obj.Cargos, function (ica, cargo) {
                        ...
                        $(""#slMotivo"").on(""change"", function (e) {
                            ...
                            if ($(this).find("":selected"").data(""esRango"")) {
                                ...
                                $(""#fend"").show();
                                $(""");
                WriteLiteral(@".texto-cambiante"").text(""Rango de Fechas de Ausencia"");
  ...
  ");
       ...
       ");
              ...
              ");
                WriteLiteral(@"      $(""#hdIdAusencia"").val(Ausencia.aus_id);
 ...
 ");
           ...
           ");
                WriteLiteral(@"                         notEmpty: {
                            ...
                            tipocontrato: {
                                validators: {
                                    notEmpty: {
                      ");
                WriteLiteral(@"                  message: 'Debe selecionar un Tipo de Contrato'
                                    }
                                }
                            },
                            fechaingreso: {
                            ...
                            cargo: {
                                validators: {
                                    notEmpty: {
                                        messa");
                WriteLiteral(@"ge: 'Debe selecionar un Cargo'
                                    }
                                }
                            }
                        }
            ...
            $(");
                WriteLiteral(@"'#modal-add-ejec').on('hidden.bs.modal', function (event) {
            ...
            $('#dp-component-inicio .input-group.date').datepicker({ autoclose: true, format: ""dd-mm-yyyy"", todayHighlight: true }).on(""c");
                WriteLiteral(@"hangeDate"", function () {
